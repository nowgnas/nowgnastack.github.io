...
- 현재 anaconda를 사용하고 있으며, python 버전은 3.7.7을 사용하고 있다.
  ![pytorch](/images/img/posts/install_pytorch/py_version.png)
...
- Get Started를 클릭한다.
  ...
  ![start](/images/img/posts/install_pytorch/getstart.png)

- pytorch버전과 os, 사용하는 패키지, 언어, cuda버전을 선택하면 명령어가 나온다.

  ![command](/images/img/posts/install_pytorch/command.png)

- 이제 명령어를 command창에 입력하면 된다.
- 4개의 패키지를 설치한다고 한다.
  ![install](/images/img/posts/install_pytorch/intalled.png)

- 설치가 완료되었다!!
  ![fin](/images/img/posts/install_pytorch/fin.png)
